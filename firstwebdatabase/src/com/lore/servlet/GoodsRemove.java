...
public class GoodsRemove extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		if (method.equals("remove")) {
			...
			/************************这块有错误******************************************/
			//out.print("<option value='0'><input value='"+bean.getKname()+"'></option>");
			out.print("<option value='7'>通讯设备</option>");
			out.print("<option value='8'>服饰</option>");
			out.print("<option value='9'>玩具</option>");
			out.print("<option value='10'>电脑</option>");
			out.print("<option value='12'>食品</option>");
			out.print("</select>");
			out.print("</div>");
